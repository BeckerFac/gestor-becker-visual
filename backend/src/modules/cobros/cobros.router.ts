...
cobrosRouter.get('/', authorize('cobros', 'view'), authorizeCircuit('query'), (req, res) => cobrosController.getCobros(req as any, res));
...
cobrosRouter.post('/', authorize('cobros', 'create'), authorizeCircuit('body'), (req, res) => cobrosController.createCobro(req as any, res));
